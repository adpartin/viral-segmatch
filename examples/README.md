...
The project's actual training uses `src/models/train_pair_classifier.py` with frozen ESM-2 embeddings precomputed via `src/embeddings/compute_esm2_embeddings.py`.
