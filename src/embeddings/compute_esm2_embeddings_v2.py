...
# ESM2_MAX_RESIDUES = 1022  # ESM-2 maximum sequence length
ESM2_PROTEIN_SEQ_COL = 'prot_seq'  # Column name for protein sequences
...
# parser.add_argument(
#     '--model',
#     type=str, default='facebook/esm2_t33_650M_UR50D',
#     help='ESM-2 model to use (default: facebook/esm2_t33_650M_UR50D)'
# )
# parser.add_argument(
#     '--batch_size',
#     type=int, default=16,
#     help='Batch size for processing (default: 16). Adjust based on GPU memory (e.g., 8 for A100 40GB).'
# )
