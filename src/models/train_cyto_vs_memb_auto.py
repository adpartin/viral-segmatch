...
Train a binary classifier for protein sequences using huggingface ESM-2 using
Trainer API.
"""
import json
import os
...
# train_tokenized = tokenizer(train_sequences) # original
# test_tokenized = tokenizer(test_sequences)   # original
train_tokenized = tokenizer(train_sequences, padding=True, truncation=True, return_tensors='pt')
test_tokenized = tokenizer(test_sequences, padding=True, truncation=True, return_tensors='pt')
