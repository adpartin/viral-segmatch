...
## 1. Terminology gate
- Every noun you use for a code entity MUST already exist in the codebase or `docs/methods/glossary.md` — grep it. If it's absent, use the existing term; do NOT coin a synonym.
- Canonical vocabulary: the "Core Vocabulary" section of `CLAUDE.md` + `docs/methods/glossary.md`. Reuse the glossary's exact phrasing.
