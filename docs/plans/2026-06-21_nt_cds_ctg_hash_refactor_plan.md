...
- Order: (a) then (b). **Both done; (c) is the remaining axis-consistency item** (the §13.4 legacy crash — populate-not-skip attach / clear error), to be discussed next.
