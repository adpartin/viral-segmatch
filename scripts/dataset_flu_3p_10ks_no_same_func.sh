#!/bin/bash
# Dataset Segment Pairs Creation for Flu A 3p_10ks_no_same_func
# Usage: ./scripts/dataset_flu_3p_10ks_no_same_func.sh
...
# Print header
log "========================================================================"
log "Dataset Segment Pairs Creation (Flu A 3p_10ks_no_same_func)"
log "========================================================================"
