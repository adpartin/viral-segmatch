#!/bin/bash
# ESM-2 Embeddings Computation for Flu A 3p_1ks
# Usage: ./scripts/esm2_flu_3p_1ks.sh
...
OUTPUT_DIR=""  # Let config determine the path (will be July_2025_seed_42_GTOs_5000_pb1_pb2_pa)
...
# Print header
log "========================================================================"
log "ESM-2 Embeddings Computation (Flu A 3p_1ks)"
log "========================================================================"
