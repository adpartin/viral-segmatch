...
# The parquet file is automatically created alongside the HDF5 file by compute_esm2_embeddings.py
EMBEDDINGS_FILE="$PROJECT_ROOT/data/embeddings/bunya/April_2025/master_esm2_embeddings.h5"
