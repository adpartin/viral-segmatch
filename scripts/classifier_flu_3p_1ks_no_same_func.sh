#!/bin/bash
# ESM-2 Frozen Pair Classifier Training for Flu A 3p_1ks_no_same_func
# Usage: ./scripts/classifier_flu_3p_1ks_no_same_func.sh
...
# Header
log "========================================================================"
log "ESM-2 Frozen Pair Classifier Training (Flu A 3p_1ks_no_same_func)"
log "========================================================================"
