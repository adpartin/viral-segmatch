#!/bin/bash
# ESM-2 Embeddings Computation for Flu A 3p_1ks_no_same_func
# Usage: ./scripts/esm2_flu_3p_1ks_no_same_func.sh
...
# Print header
log "========================================================================"
log "ESM-2 Embeddings Computation (Flu A 3p_1ks_no_same_func)"
log "========================================================================"
