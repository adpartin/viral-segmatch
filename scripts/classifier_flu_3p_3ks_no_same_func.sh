#!/bin/bash
# ESM-2 Frozen Pair Classifier Training for Flu A 3p_3ks_no_same_func
# Usage: ./scripts/classifier_flu_3p_3ks_no_same_func.sh
# 3p_3ks: 3 major proteins (PB1, PB2, PA) and 3k isolates sampled from the full dataset.
...
# Configuration
CONFIG_BUNDLE="flu_a_3p_3ks_no_same_func"
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
LOG_DIR="$PROJECT_ROOT/logs/training"
LOG_FILE="$LOG_DIR/train_esm2_frozen_pair_classifier_${CONFIG_BUNDLE}_${TIMESTAMP}.log"

# Path overrides - use 3p_3ks directories
DATASET_DIR="$PROJECT_ROOT/data/datasets/flu_a/July_2025_seed_42_isolates_3000"
EMBEDDINGS_DIR="$PROJECT_ROOT/data/embeddings/flu_a/July_2025_seed_42_isolates_3000"
OUTPUT_DIR="$PROJECT_ROOT/models/flu_a/July_2025_seed_42_isolates_3000"

CUDA_NAME="cuda:6"  # CUDA device
...
# Header
log "========================================================================"
log "ESM-2 Frozen Pair Classifier Training (Flu A 3p_3ks_no_same_func)"
log "========================================================================"
