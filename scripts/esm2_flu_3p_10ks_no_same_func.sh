#!/bin/bash
# ESM-2 Embeddings Computation for Flu A 3p_10ks_no_same_func
# Usage: ./scripts/esm2_flu_3p_10ks_no_same_func.sh
...
# Path overrides - use existing preprocessing, save to 3p_10ks directories
INPUT_FILE="$PROJECT_ROOT/data/processed/flu_a/July_2025/protein_final.csv"  # Use preprocessed data
OUTPUT_DIR=""  # Let config determine the path (will be July_2025_seed_42_isolates_10000)
...
# Print header
log "========================================================================"
log "ESM-2 Embeddings Computation (Flu A 3p_10ks_no_same_func)"
log "========================================================================"
