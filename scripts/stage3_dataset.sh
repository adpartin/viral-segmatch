...
# Usage: ./scripts/stage3_dataset.sh <config_bundle> [--input_file INPUT] [--output_dir OUTPUT]
# Example: ./scripts/stage3_dataset.sh bunya
#          ./scripts/stage3_dataset.sh flu_a_3p_1ks
#          ./scripts/stage3_dataset.sh flu_a_plateau_analysis --output_dir /custom/path
...
# Print header
log "========================================================================"
log "Stage 3: Dataset Segment Pairs Creation"
log "========================================================================"
