#!/bin/bash
# Dataset Segment Pairs Creation for Flu A 3p_1ks_no_same_func
# Usage: ./scripts/dataset_flu_3p_1ks_no_same_func.sh
...
# Configuration
CONFIG_BUNDLE="flu_a_3p_1ks_no_same_func"
...
OUTPUT_DIR="" # Let config determine the path (will be July_2025_seed_42_isolates_1000)
...
# Print header
log "========================================================================"
log "Dataset Segment Pairs Creation (Flu A 3p_1ks_no_same_func)"
log "========================================================================"
